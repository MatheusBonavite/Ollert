                ...
                <form className="col s12">
                    ...
                    <div className="row">
                        <div className="input-field col s6">
                            <input id="card_title" type="text" className="validate" />
                            <label htmlFor="card_title">Card Title</label>
                        </div>
                        <div className="input-field col s6">
                            <input id="small_description" type="text" className="validate" />
                            <label htmlFor="small_description">Card Short Description</label>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="input-field col s6">
                            ...
                            <input id="get_deadline" type="text" className="datepicker" />
                            <label htmlFor="get_deadline">Deadline</label>
                        </div>
                        <div className="input-field col s6">
                            <ListDropdown id={"priority"} title={"Select Priority"} list={this.priorityMatcher()}/>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="input-field col s12">
                            <p className="range-field">
                                <input id="to_complete" type="range" min="1" max="40" className="active"/>
                            </p>
                            <label htmlFor="to_complete">Time to Complete (Hours)</label>
                        </div>
                    </div>
                    <button
                            id="submit_form"
                            ...
                            type="submit"
                            name="action"
                            onClick={(event) => {this.handleSubmit(event, cardHandler)}}
                        >
                            Submit
                    </button>
                </form>
